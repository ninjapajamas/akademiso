...
// Simple inline SVG social icons (no external dependency needed)
...
export default function Footer() {
    const socialLinks = [
        { href: '#', icon: <IconLinkedIn />, label: 'LinkedIn', color: 'hover:bg-blue-600 hover:text-white hover:border-blue-600' },
        { href: '#', icon: <IconInstagram />, label: 'Instagram', color: 'hover:bg-pink-500 hover:text-white hover:border-pink-500' },
        { href: '#', icon: <IconWhatsApp />, label: 'WhatsApp', color: 'hover:bg-green-500 hover:text-white hover:border-green-500' },
    ];
