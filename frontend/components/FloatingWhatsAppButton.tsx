...
export default function FloatingWhatsAppButton() {
    return (
        <a
            ...
            className="fixed bottom-5 right-5 z-[60] flex h-15 w-15 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_40px_rgba(37,211,102,0.35)] transition-all duration-300 hover:-translate-y-1 hover:scale-[1.03] hover:bg-[#1fbe5c] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 sm:bottom-6 sm:right-6"
        >
