...
export default function DashboardPage() {
    ...
    useEffect(() => {
        ...
        const fetchCourses = async () => {
            try {
                ...
                if (res.ok) setEnrolledCourses(await res.json());
    ...
    const completed = enrolledCourses.filter(e => e.status === 'Completed').length;
    const pending = enrolledCourses.filter(e => e.status === 'Pending').length;
        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 md:p-10 text-white shadow-xl shadow-blue-600/20 relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <Link href="/courses" className="inline-flex items-center gap-2 mt-5 bg-white text-blue-700 font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-blue-50 transition-colors">
            ...
            <div className="space-y-5">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {isLoading ? (
                        [1, 2].map(i => <div key={i} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 h-40 animate-pulse" />)
                                ...
                                <div className="flex-1 flex flex-col justify-between min-w-0">
                                    ...
                                    <div className="space-y-1.5 mt-2">
                                        <div className="flex justify-between text-xs font-semibold">
                                            ...
                                            <span className="text-blue-600">{enrollment.status === 'Completed' ? '100%' : '0%'}</span>
                                        </div>
            ...
            <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-3">
                    {[
                        ...
                        <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-blue-50/40 transition-colors">
