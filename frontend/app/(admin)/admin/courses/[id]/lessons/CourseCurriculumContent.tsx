    ...
    const handleAddSection = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                await showError(`Gagal menambah modul: ${JSON.stringify(errorData)}`, 'Penambahan Gagal');
            }
        } catch (error) {
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-0.5">Kelola modul dan materi seperti di portal trainer.</p>
                </div>
            </div>
                        ...
                        <div className="flex items-center justify-between p-6 bg-gray-50/50 border-b border-gray-50">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-white text-blue-600 border border-blue-100 rounded-xl text-xs font-bold hover:bg-blue-50 transition-all"
                                >
                        ...
                        <div className="p-5 border-b border-gray-100">
                            <div className="space-y-3">
                                ...
                                <select
                                    ...
                                    className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-bold text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                                >
                        ...
                        <div className="max-h-[56vh] overflow-y-auto p-5 space-y-3">
                            {materialBankLoading ? (
                                ...
                                filteredMaterialBankItems.map((lesson) => (
                                    <div key={lesson.id} className="rounded-2xl border border-gray-100 p-4 hover:border-blue-100 hover:bg-gray-50 transition-all">
                                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                            <div className="min-w-0">
                                                ...
                                                <div className="mt-3 flex flex-wrap gap-2 text-[10px] font-black uppercase tracking-widest">
                                                    <span className="rounded-lg bg-blue-50 px-2 py-1 text-blue-600">{getLessonTypeLabel(lesson.type)}</span>
                                            ...
                                            <button
                                                ...
                                                className="rounded-2xl bg-blue-600 px-5 py-3 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-blue-600/20 hover:bg-blue-700 disabled:opacity-40"
                                            >
