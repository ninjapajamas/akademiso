...
from .views import (
    ...
    MidtransNotificationView, QuizAttemptView, QuizLeaderboardView, PostTestFeedbackView, CourseFeedbackListView, SatisfactionFeedbackView, CompleteLessonView, AccessLessonView,
    GamificationSummaryView, GamificationLeaderboardView, GamificationActivityView, GamificationRewardsView, GamificationRewardClaimView,
...
urlpatterns = [
    ...
    path('gamification/rewards/', GamificationRewardsView.as_view(), name='gamification-rewards'),
    path('gamification/rewards/<str:reward_key>/claim/', GamificationRewardClaimView.as_view(), name='gamification-reward-claim'),
    ...
    path('lessons/<int:lesson_id>/quiz-leaderboard/', QuizLeaderboardView.as_view(), name='quiz-leaderboard'),
